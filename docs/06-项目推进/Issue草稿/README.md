---
type: issue-draft-index
status: active
phase: v1
owner: project-lead
tags: [github, issues, execution, week1, week2]
---

# Issue草稿

这里保存第 1-2 周 GitHub Issues 草稿。正式执行时，把每个草稿复制到 GitHub Issue，并放入 GitHub Project。

## 使用规则

1. 不要把一个大任务写成一句话。
2. 每个 Issue 必须有负责人角色、开始日期、截止日期、操作步骤、验收标准、测试方式。
3. 真实 GitHub 账号未确定前，Owner 先写 A/B/C。
4. Issue 创建后，在本页补充 GitHub 链接。
5. 如果任务变化，先改 GitHub Issue，再同步回 Obsidian。

## 第 1-2 周首批任务

| Issue | Owner | 截止日期 | Claude 审核 | 客户可见 |
|---|---|---|---|---|
| [[A-01 创建 Next.js 项目骨架]] | A | 2026-06-03 | 否 | 否 |
| [[A-02 配置 Prisma 和 PostgreSQL]] | A | 2026-06-05 | 是 | 否 |
| [[A-03 建 tenants-users-roles 基础模型]] | A | 2026-06-10 | 是 | 否 |
| [[A-04 写租户隔离测试]] | A | 2026-06-12 | 是 | 否 |
| [[B-01 绘制平台总控页面结构]] | B | 2026-06-03 | 否 | 是 |
| [[B-02 客户后台信息架构]] | B | 2026-06-05 | 否 | 是 |
| [[B-03 手机端轻工作台结构]] | B | 2026-06-12 | 否 | 是 |
